...
include "webservice/projectType_web.php";
...
<div class = "imsz"  class= " row" style="height: 500px;">
<?php if($proj_we_love){ ?>
  <h2><b>Project We Love</b></h2>
  <?php } else if($proj_nearly_funded){ ?>
  <h2><b>Project Nearly Funded</b></h2>
 <?php } else if($proj_just_launched){ ?>
  <h2><b>Project Just Launched</b></h2>
  <?php } else if($proj_everything){ ?>
  <h2><b>EveryThing</b></h2>
  <?php } ?>
...
<?php } ?>
<?php }else if($project_nearly_funded){ ?>
