...
header('Location:'.$url);
  ...
  include "webservice/edit_profile_web.php";
...
<form class="form" action="" id="contactForm" style="padding-top:20px;" method="post" enctype="multipart/form-data">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" id="password_id"  name="password_id">
  </div>
...
<!-- 
  <BUTTON class="btn btn-primary" style="float: right;" id="edit_btn">Submit</BUTTON> -->
