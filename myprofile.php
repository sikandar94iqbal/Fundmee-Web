...
include "webservice/my_profile_web.php";
...
<?php if($info_available == false) { ?>
  ...
  <div class="row" style="margin-top: 50px;">
        ...
        <div class = "col-md-4" style= "text-align:center;">
          <h1><b><?php echo $user_name ?></b>
          <a href="edit_info.php"><i class="material-icons" style="font-size:25px; margin-left: 16px;">mode_edit</i></a>
...
<a href="#" class="fa fa-google"></a>
  ...
  <div class="row" style="margin-top: 50px;">
        ...
        <div class = "col-md-4" style= "text-align:center;">
          <h1><b><?php echo $user_name ?></b>
 <a href="edit_info.php"><i class="material-icons" style="font-size:25px; margin-left: 6px;">mode_edit</i></a>
...
<div class="row" style="padding-bottom: 50px;">
  <div class="col-sm-12">
    <h3><b>My Projects</b> (<?php echo $row_cnt4 ?>) </h3>
