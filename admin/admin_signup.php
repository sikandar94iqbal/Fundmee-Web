...
include "webservice/admin_signup_web.php";
...
<input id="signup_button" class="btn" type="submit"  value="submit" name="submit" />
				                    </form>
			                    </div>
                        	</div>
                     ...
                     <div>
                        <a href="admin_login.php"><span><strong style="color:#fff;">Already have an account?</strong></span></a>
<br>
