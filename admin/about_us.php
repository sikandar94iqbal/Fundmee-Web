...
include "webservice/about_us_web.php";
...
<div class="col-sm-12 ">
 ...
 <i style="cursor: pointer;" data-toggle="modal" data-target="#myModal_edit" class="glyphicon glyphicon-pencil" style="font-size:25px; margin-left: 16px;"></i>
...
<div id="myModal_edit" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"><b>Edit About Us page</b></h4>
      </div>
      <div class="modal-body">
       
       
       <form action="webservice/edit_about_us.php" method="post">
  ...
  <div class="form-group">
    <label for="email">Text :</label>
     <textarea class="form-control" rows="15" id="edit_text" name="edit_text"></textarea>
  </div>
...
<footer id="myFooter"  style="background-color: #535353; color: #000;">
        ...
        <div class="second-bar" style="background-color: #125B58;">
           <div class="container">
                <h2 class="logo"><a href="#"> Fundmee </a></h2>
