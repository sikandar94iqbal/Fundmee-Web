...
header('Location:'.$url);
  ...
  include "webservice/notification_web.php";
...
if($status_msg == 0){
$colors = "background-color: #f2f2f2; padding: 10px; margin-bottom: 20px;";
}
else{
$colors = "background-color: #fff; padding: 10px; margin-bottom: 20px;";
  }
  ?>   

<a href="ind_notification.php?id=<?php echo $temp_back_id ?>"> 
<div class="row" id="rcorners2" style="<?php echo $colors ?>">
<div class="col-sm-6">
<h5><b><?php echo $name ?></b> backed your project</h5>
<span id="paragraph"><?php echo $project_title ?> </span>
<br>
<span>Funded <b><?php echo $fund ?> PKR</b></span>
</div>
</div>
</a>
<?php endwhile; ?>
