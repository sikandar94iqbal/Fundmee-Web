...
include "webservice/ind_notifications_web.php";
...
<h3>Total target : PKR <b><?php echo $fund_target ?></b></h3>
<h3>Funded : PKR <b><?php echo $amount ?></b></h3>
...
<div class="row">
<div class="col-sm-8">
<h5><b><?php echo  $name ?></b> backed your <span id="paragraph"><?php echo $project_title ?> </span></h5>
<h5 id="paragraph">Transaction pin : <b><?php echo $t_pin ?></b></h5>
<br>
...
<input type="hidden" name="backer_id" id="backer_id" value="<?php echo $backer_id ?>">
<input type="hidden" name="amount_id" id="amount_id" value="<?php echo $amount ?>">

<input type="hidden" name="temp_back_id" id="temp_back_id" value="<?php echo $new_notif ?>">

<?php if($already_backed){ ?>

    <button id="back_id" style=" width: 190px; height: 50px; font-size: 17px; float: left;"  class="btn btn-primary" disabled><b>FUND RECIEVED</b></button>

<?php } else { ?>

    <button id="back_id" style=" width: 190px; height: 50px; font-size: 17px; float: left;"  class="btn btn-primary"><b>FUND RECIEVED</b></button>
