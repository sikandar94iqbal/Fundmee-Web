...
header('Location:'.$url);
  ...
  include "webservice/add_bank_info_web.php";
...
<form class="form" action="" id="contactForm" style="padding-top:20px;" method="post" enctype="multipart/form-data">
  <div class="form-group">
    <label for="text">Bank branch :</label>
    <input type="text" class="form-control" id="bank_branch_id" name="bank_branch_id">
  </div>

 <div class="form-group">
    <label for="text">Bank Account No :</label>
    <input type="text" class="form-control" id="bank_acc_id"  name="bank_acc_id">
  </div>

<h2><b>Add EasyPaisa Info </b></h2>

   <div class="form-group">
    <label for="text">CNIC :</label>
    <input type="text" class="form-control" id="cnic_id"  name="cnic_id">
  </div>

  <div class="form-group">
    <label for="text">EasyPaisa Phone No :</label>
